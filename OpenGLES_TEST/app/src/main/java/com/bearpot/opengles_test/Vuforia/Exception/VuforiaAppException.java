package com.bearpot.opengles_test.Vuforia.Exception;

/**
 * Created by dg.jung on 2018-01-30.
 */

public class VuforiaAppException extends Exception {
    ...
    public VuforiaAppException(int code, String description) {
        super(description);
        mCode = code;
        mString = description;
    }
